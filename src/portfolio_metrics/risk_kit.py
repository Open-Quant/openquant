...
def get_total_market_index_returns():
    """
    Loads industry portfolio data and derive the returns of a capweighted total market index
    """
...
def floor_allocator(psp_r, ghp_r, floor, zc_prices, m = 3):
    ...
    for step in range(n_steps):
        floor_value = floor * zc_prices.iloc[step] # PV of Floor assuming today's rates and flat Yield Curve
        cushion = (account_value - floor_value)/account_value
