...
## Purpose
Purged k-fold split diagnostics and combinatorial purged cross-validation (CPCV) splits and paths per AFML Chapter 7 and §12.4, re-ported from stranded commit `59ac6fa` (issue #33, ADR 0002).
