# Docs Writing Prompt: CHAPTER 4 -> sb_bagging

## Scope
- Chapter: `CHAPTER 4`
- Module: `sb_bagging` (`/module/sb-bagging`)
- Source files:
...
2. `afml_search(query="Bagging classifiers uniqueness sequential bootstrap", chapter="CHAPTER 4", top_k=3)`
3. `afml_get_context(query="Bagging classifiers uniqueness sequential bootstrap", chapter="CHAPTER 4", top_k=2, window=1)`
