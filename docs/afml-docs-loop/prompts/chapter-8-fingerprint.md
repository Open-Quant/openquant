# Docs Writing Prompt: CHAPTER 8 -> fingerprint
...
2. `afml_search(query="feature effects substitution effects", chapter="CHAPTER 8", top_k=3)`
3. `afml_get_context(query="feature effects substitution effects", chapter="CHAPTER 8", top_k=2, window=1)`
...
- Module anchor: `afml-S00617-c000206` pages 159-160 (SUBSTITUTION EFFECTS)
