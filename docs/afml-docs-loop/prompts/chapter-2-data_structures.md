# Docs Writing Prompt: CHAPTER 2 -> data_structures

## Scope
- Chapter: `CHAPTER 2`
- Module: `data_structures` (`/module/data-structures`)
- Source files:
...
2. `afml_search(query="Standard Bars time bars imbalance bars run bars", chapter="CHAPTER 2", top_k=3)`
3. `afml_get_context(query="Standard Bars time bars imbalance bars run bars", chapter="CHAPTER 2", top_k=2, window=1)`
...
- Module anchor: `afml-S00417-c000059` pages 55-56 (2.3.1.1 Time Bars)
