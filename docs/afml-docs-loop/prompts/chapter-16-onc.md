# Docs Writing Prompt: CHAPTER 16 -> onc

## Scope
- Chapter: `CHAPTER 16`
- Module: `onc` (`/module/onc`)
- Source files:
...
2. `afml_search(query="optimal number of clusters", chapter="CHAPTER 16", top_k=3)`
3. `afml_get_context(query="optimal number of clusters", chapter="CHAPTER 16", top_k=2, window=1)`
