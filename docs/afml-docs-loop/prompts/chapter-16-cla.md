# Docs Writing Prompt: CHAPTER 16 -> cla

## Scope
- Chapter: `CHAPTER 16`
- Module: `cla` (`/module/cla`)
- Source files:
...
2. `afml_search(query="critical line algorithm mean-variance constraints", chapter="CHAPTER 16", top_k=3)`
3. `afml_get_context(query="critical line algorithm mean-variance constraints", chapter="CHAPTER 16", top_k=2, window=1)`
...
- Module anchor: `afml-S00857-c000371` pages 297-297 (16.1 MOTIVATION)
