# Docs Writing Prompt: CHAPTER 14 -> backtest_statistics

## Scope
- Chapter: `CHAPTER 14`
- Module: `backtest_statistics` (`/module/backtest-statistics`)
- Source files:
...
2. `afml_search(query="Deflated Sharpe Ratio probabilistic Sharpe drawdown", chapter="CHAPTER 14", top_k=3)`
3. `afml_get_context(query="Deflated Sharpe Ratio probabilistic Sharpe drawdown", chapter="CHAPTER 14", top_k=2, window=1)`
...
- Module anchor: `afml-S00812-c000338` pages 274-276 (14.7.3 The Deflated Sharpe Ratio)
