# Docs Writing Prompt: CHAPTER 16 -> portfolio_optimization

## Scope
- Chapter: `CHAPTER 16`
- Module: `portfolio_optimization` (`/module/portfolio-optimization`)
- Source files:
...
2. `afml_search(query="Markowitz portfolio optimization covariance", chapter="CHAPTER 16", top_k=3)`
3. `afml_get_context(query="Markowitz portfolio optimization covariance", chapter="CHAPTER 16", top_k=2, window=1)`
...
- Module anchor: `afml-S00859-c000372` pages 297-298 (OPTIMIZATION)
