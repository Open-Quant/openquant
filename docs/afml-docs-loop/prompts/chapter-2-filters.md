# Docs Writing Prompt: CHAPTER 2 -> filters
...
2. `afml_search(query="CUSUM filter event-based sampling", chapter="CHAPTER 2", top_k=3)`
3. `afml_get_context(query="CUSUM filter event-based sampling", chapter="CHAPTER 2", top_k=2, window=1)`
...
- Module anchor: `afml-S00416-c000058` pages 55-55 (2.3.1 Standard Bars)
