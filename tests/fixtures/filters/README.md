...
- `dollar_bar_sample.csv`: copied from mlfinlab v0.8.0 `tests/test_data/dollar_bar_sample.csv`
  (BSD-3-Clause; see `tests/FIXTURES.md`).
- `events.json`: CUSUM and z-score filter events on `dollar_bar_sample.csv`, written by
