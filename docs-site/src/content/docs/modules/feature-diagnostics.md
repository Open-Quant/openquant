...
b          0.337   0.383  -0.633
noise_1    0.018  -0.002  -0.696
noise_2    0.015  -0.001  -0.695
a ~ a_copy: corr 0.981, singly 0.622, jointly 0.643
```

Read across the `a_copy` row. MDA says it is nearly worthless, 0.014 against 0.608 for `a`.
