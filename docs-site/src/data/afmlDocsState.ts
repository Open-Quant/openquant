// Chapter-to-module map for the by-chapter index. Originally exported by a docs loop
// that was removed (docs/decisions/0001-remove-afml-scraping-tooling.md); maintained by hand now.
